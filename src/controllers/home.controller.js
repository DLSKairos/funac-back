...
const streamPdf = (pdf, disposition, res) => {
...
const downloadPdf = async (req, res) => {
  ...
  streamPdf(pdf, 'attachment', res);
};

// Sirve el PDF para vista previa embebida (inline, sin forzar descarga ni contar como descarga)
const viewPdf = async (req, res) => {
  ...
  streamPdf(pdf, 'inline', res);
};

module.exports = { getImages, getPdfs, downloadPdf, viewPdf };
